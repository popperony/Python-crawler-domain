...
def get_all_website_links(url):
    ...
    try:
        global soup
        soup = BeautifulSoup(requests.get(url).content, "html.parser", from_encoding="iso-8859-1")  # NOQA E501
    ...
    for a_tag in soup.findAll("a"):
        ...
        href = parsed_href.scheme + "://" + parsed_href.netloc + parsed_href.path  # NOQA E501
